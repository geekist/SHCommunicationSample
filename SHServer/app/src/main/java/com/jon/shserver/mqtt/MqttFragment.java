...
import static com.jon.shserver.mqtt.AliMqttClient.MSG_CONNECTION_LOST;
import static com.jon.shserver.mqtt.AliMqttClient.MSG_CONNECT_FAILED;
import static com.jon.shserver.mqtt.AliMqttClient.MSG_CONNECT_SUCCESS;
import static com.jon.shserver.mqtt.AliMqttClient.MSG_DELIVERY_COMPLETE;
import static com.jon.shserver.mqtt.AliMqttClient.MSG_MESSAGE_ARRIVED;
import static com.jon.shserver.mqtt.AliMqttClient.MSG_PUBLISH_FAILED;
import static com.jon.shserver.mqtt.AliMqttClient.MSG_PUBLISH_SUCCESS;
import static com.jon.shserver.mqtt.AliMqttClient.MSG_SUBSCRIBE_FAILED;
import static com.jon.shserver.mqtt.AliMqttClient.MSG_SUBSCRIBE_SUCCESS;
import static com.jon.shserver.mqtt.DeviceInfo.PUBLISH_TOPIC;
import static com.jon.shserver.mqtt.DeviceInfo.SUBSCRIBE_TOPIC;
...
public class MqttFragment extends Fragment implements View.OnClickListener{
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.button_send:
                publishTopic(PUBLISH_TOPIC,getPayload());
                break;
    ...
    public void publishTopic(String topic,String payload) {
        aliMqttClient.publishMessage(topic,payload);
    }

    public void subscribeTopic(String topic) {
        aliMqttClient.subscribeTopic(topic);
    }
