...
public class TCPConstants {
    ...
    public static final int MSG_SERVER_STOPPED = 8002;
    ...
    public static final int MSG_SUBTHREAD_WRITE = 24; //sub thread to send data
    public static final int MSG_SUBTHREAD_READ = 25; //sub thread to send data
